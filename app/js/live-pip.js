...
(function () {
  ...
  function ensureShellCss() {
    ...
    s.textContent =
      ...
      '#lpip-shellbar{position:fixed;top:14px;left:50%;transform:translateX(-50%);z-index:2147482500;display:flex;align-items:center;gap:12px;padding:9px 10px 9px 17px;border-radius:999px;background:rgba(10,10,12,.9);color:#f0f0f0;border:1px solid rgba(255,255,255,.16);box-shadow:0 12px 40px rgba(0,0,0,.5);font:600 13px/1 Archivo,Georgia,serif;-webkit-backdrop-filter:blur(8px);backdrop-filter:blur(8px);max-width:calc(100vw - 28px);animation:lpipShellBarIn .25s cubic-bezier(.2,.8,.2,1)}' +
