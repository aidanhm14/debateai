...
(function () {
  ...
  function injectStyles() {
    ...
    var css = [
      '.sp-card{border:1px solid rgba(127,127,127,.28);border-radius:16px;padding:26px 26px 22px;',
      'background:var(--c-surface,rgba(127,127,127,.06));max-width:720px;margin:0 auto;',
      'font-family:inherit;line-height:1.45}',
      '.sp-eyebrow{font-size:13px;letter-spacing:.1em;text-transform:uppercase;opacity:.68;',
      'margin:0 0 10px;font-weight:700}',
      '.sp-q{font-size:22px;font-weight:650;line-height:1.35;margin:0 0 6px}',
      '.sp-sub{font-size:16px;opacity:.68;margin:0 0 18px}',
      '.sp-scale{display:flex;gap:7px;margin:0 0 8px}',
      '.sp-opt{flex:1;border:1px solid rgba(127,127,127,.3);background:transparent;color:inherit;',
      'border-radius:10px;padding:12px 4px;cursor:pointer;font:inherit;font-size:14px;',
      'transition:background .12s,border-color .12s,transform .12s}',
      '.sp-opt:hover{background:rgba(239,68,68,.09);border-color:rgba(239,68,68,.45)}',
      '.sp-opt[aria-pressed="true"]{background:#b91c1c;border-color:#b91c1c;color:#fff;font-weight:600}',
      '.sp-ends{display:flex;justify-content:space-between;font-size:13px;opacity:.56;margin:0 0 18px}',
      '.sp-conf{margin:0 0 18px}',
      '.sp-conf label{font-size:15px;opacity:.76;display:block;margin:0 0 8px}',
      '.sp-conf input{width:100%;accent-color:#ef4444}',
      '.sp-why{width:100%;box-sizing:border-box;border:1px solid rgba(127,127,127,.3);',
      'border-radius:10px;padding:12px 13px;font:inherit;font-size:16px;background:transparent;',
      'color:inherit;resize:vertical;min-height:72px;margin:0 0 14px}',
      '.sp-actions{display:flex;gap:10px;align-items:center}',
      '.sp-go{background:#b91c1c;color:#fff;border:0;border-radius:10px;padding:12px 20px;',
      ...
      'font-size:15px;cursor:pointer;padding:11px 6px}',
      ...
      '.sp-legend{display:flex;justify-content:space-between;font-size:14px;opacity:.72}',
      '.sp-note{font-size:15px;opacity:.78;margin:12px 0 0}',
      '.sp-count{font-size:13px;opacity:.56;margin:12px 0 0}',
      '.sp-err{font-size:15px;color:#ef4444;margin:10px 0 0}',
      '@media(max-width:520px){.sp-card{padding:20px 16px 18px}.sp-q{font-size:19px}.sp-sub{font-size:15px}.sp-scale{flex-wrap:wrap}.sp-opt{flex:1 1 30%;font-size:13px;padding:11px 4px}}',
    ].join('');
