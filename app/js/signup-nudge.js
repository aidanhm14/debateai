...
(function(){
  ...
  function injectStyle(){
    ...
    s.textContent =
      '.signup-nudge{position:fixed;inset:0;z-index:100000;display:flex;align-items:center;justify-content:center;padding:20px;font-family:"Archivo","Archivo",system-ui,-apple-system,sans-serif;opacity:0;transition:opacity .22s ease}' +
