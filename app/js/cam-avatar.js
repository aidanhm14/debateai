...
(function () {
  ...
  function installDesignerStyles() {
    ...
    style.textContent =
      ...
      '.dac-choice{appearance:none;border:1px solid rgba(255,255,255,.13);border-radius:10px;background:rgba(255,255,255,.035);color:rgba(240,237,230,.72);min-height:35px;padding:8px 11px;font:650 12px/1 DM Sans,Archivo,Georgia,serif;cursor:pointer;transition:border-color .15s,background .15s,color .15s,transform .15s}' +
      ...
      '.dac-foot button{appearance:none;border:1px solid rgba(255,255,255,.15);border-radius:10px;padding:10px 14px;background:rgba(255,255,255,.04);color:#f0ede6;font:700 12px/1 DM Sans,Archivo,Georgia,serif;cursor:pointer}' +
