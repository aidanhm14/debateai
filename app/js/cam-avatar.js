...
(function () {
  ...
  function installDesignerStyles() {
    ...
    style.textContent =
      '.dac-overlay{position:fixed;inset:0;z-index:2147483000;display:grid;place-items:center;padding:18px;background:rgba(2,2,4,.82);backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px);font-family:Archivo,Georgia,serif;color:#f0ede6}' +
      ...
      '.dac-look-name{width:100%;height:38px;border:1px solid rgba(255,255,255,.14);border-radius:10px;background:rgba(255,255,255,.04);color:#f0ede6;padding:0 11px;font:650 12px/1 Archivo,Georgia,serif;outline:none}' +
      ...
      '.dac-choice{appearance:none;border:1px solid rgba(255,255,255,.13);border-radius:10px;background:rgba(255,255,255,.035);color:rgba(240,237,230,.72);min-height:35px;padding:8px 11px;font:650 12px/1 Archivo,Georgia,serif;cursor:pointer;transition:border-color .15s,background .15s,color .15s,transform .15s}' +
      ...
      '.dac-foot button{appearance:none;border:1px solid rgba(255,255,255,.15);border-radius:10px;padding:10px 14px;background:rgba(255,255,255,.04);color:#f0ede6;font:700 12px/1 Archivo,Georgia,serif;cursor:pointer}' +
