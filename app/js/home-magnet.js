...
(function () {
  ...
  var NO_POPUP = /\/(leaderboard|users|profile|live|live-round|spar|casual-room|debate-chat|exhibition|predict|voice-rfd|admin|admin-rate|admin-runner|linter|argument-coach|verify|voice-debate|newvoice|messages|room-judge|practice|float)(\.html)?$/.test(lower);
