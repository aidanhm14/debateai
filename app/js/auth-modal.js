...
(function () {
  ...
  function ensureBrandFont() {
    try {
      ...
      link.rel = 'stylesheet';
      link.href = 'https://fonts.googleapis.com/css2?family=Archivo:wdth,wght@62..125,100..900&family=Source+Serif+4:opsz,wght@8..60,200..900&display=swap';
  ...
  function injectStyles() {
    ...
    s.textContent =
      ...
      '#ditAuth .da-live-person{display:inline-flex;align-items:center;gap:7px;margin:0 28px 14px 0;padding:7px 10px;border-radius:999px;background:rgba(22,163,74,.1);color:' + (dark ? '#bbf7d0' : '#166534') + ';font-family:"Archivo","Archivo",system-ui,sans-serif;font-size:11px;font-weight:800;line-height:1.3;letter-spacing:.06em;text-transform:uppercase}' +
