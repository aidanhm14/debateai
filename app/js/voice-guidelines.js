// Client-side stub: the real voice bank now lives server-side in
...
// core of DebateOS's voice IP. It now stays on the server.
//
// Known tradeoff: BYOK (bring-your-own-key) requests bypass the Netlify
// proxy and go straight to Anthropic, so they do not get voice injection.
// BYOK is a power-user path, so that loss of voice polish is acceptable in exchange for
...
// simply adds an empty string: no breakage and no double-injection.
(function (global) {
