...
(function () {
  ...
  var GATED = [
    ...
    '/api/grok', '/api/live-judge', '/api/private-judge', '/api/log-generation', '/api/log-opinion-delta',
    '/api/record-extract',
    ...
    '/api/openai-chat', '/api/openlab', '/api/realtime-session', '/api/voice-preview', '/api/voice-claim',
  ...
  var AUTH_ROUTES = [
    ...
    '/api/openai-chat', '/api/deepseek', '/api/live-judge', '/api/private-judge', '/api/openlab',
