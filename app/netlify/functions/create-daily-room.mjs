...
//
// Contract:
//   POST /api/create-daily-room { name: "DebateIt-c123" }
//   → { url: "https://<sub>.daily.co/DebateIt-c123", name }
//
...
export default async (req) => {
  ...
  // room.url is the canonical URL (e.g., https://debateai.daily.co/DebateIt-c123).
