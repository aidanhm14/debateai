...
THE RESOLUTION:
- Lead with a familiar disagreement people can react to immediately. Match the room's interests and mood: films, games, sport, food and everyday annoyances work for a playful round; work, money, technology and public choices work for a serious one. Relationship questions are one option among these, never the automatic fallback.
- Examples of clear claims: knowing a movie's ending makes it more enjoyable; competitive gaming deserves the same status as traditional sports; employers should publish every employee's salary; people should be able to pay more to skip a queue. These illustrate different kinds of disagreement, not a menu to recite or default topics. Follow what this room actually said. Avoid niche policy machinery or a contrived philosophical twist.
