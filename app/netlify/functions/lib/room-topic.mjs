...
THE RESOLUTION:
- Lead with a familiar disagreement people can react to immediately, such as whether all drugs should be legal or whether cheating back is justified. These are examples of direct wording, not default topics: follow what this room actually said. Avoid niche policy machinery or a contrived philosophical twist.
