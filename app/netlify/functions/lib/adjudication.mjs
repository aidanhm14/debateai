...
// panellist ballots from top BP / WUDC, WSDC, and APDA out-rounds. This is
// the SINGLE SOURCE OF TRUTH for how the AI judge REASONS when it writes an
// RFD, orders a room, or scores speakers. It is injected server-side so the
