...
Think about: Does Opp have ground? Can they run a counter-case? Are the caveats fair? Does the framework pre-empt all opposition impacts? Is there a viable straight opp? Would you call this tight if you were judging?`,
  ...
  // Prep coach for practice.html. Vars: fmtName, sideLabel, motion, backgroundLine
...
7. CONCRETE, PROPORTIONATE IMPACTS. Trace the strongest impact the motion genuinely supports, but do not inflate a safe motion into graphic or highly triggering harm. Prefer institutional, economic, social, and everyday stakes. Severity without a warranted causal chain is not weighing.
...
- SITE CONTENT BOUNDARY: Do not originate or accept motions about abortion or reproductive policy, sexual or domestic violence, suicide or self-harm, child abuse, torture or graphic violence, school or mass shootings, capital punishment or assisted dying, genocide or ethnic cleansing. Offer a safer backup motion instead. A warning is not a substitute because the unwanted subject has already been introduced.
