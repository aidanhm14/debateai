...
<div class="note">
  <b>About this list.</b> Public Tabroom.com tournament records, refreshed ${UPDATED}. A sample of the active circuit in ${esc(name)}, not a census. School and program names only; no personal information. Your program missing or misplaced? <a href="mailto:hello@itsdebatable.com">Tell us</a>. Coaching in ${esc(name)}? Add yourself to the <a href="/coaches">coach directory</a>.
</div>`;
