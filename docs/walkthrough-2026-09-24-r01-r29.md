...
R28, R18 and R12 were decided by Aidan on 2026-09-25 and are shipped (`f06224ff`).

1. **Public-broadcast stage 18+.** `stage.mjs` still requires an adult band that no new account can now record. Keep it 18+ with its own question, or open it?
2. **R01 and R13 "and number".** R01's likely target is the homepage invitation panel (frame 0:08); confirm, and say whether a vote count was wanted on Watch.
