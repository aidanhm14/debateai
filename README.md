...
| AI brains | 6 |
| Voice personas | 16 |
| Lines in `app/practice.html` | 5,500+ |
...
- **5,500-line single-file React-via-CDN** in [app/practice.html](app/practice.html). No JSX, no bundler, no shadow DOM. Edits are surgical. Hot-reload is the browser refresh button.
