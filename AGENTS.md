...
> **Message opponent (Aidan, 2026-09-23).** The live room's action row and completed-round actions expose the existing private DM composer. Keep it distinct from room Chat and addressed to the opponent's account, including after an agreed side swap. Opening or drafting a message never sends it.
